...
Система контроля версий позволяет работать над одним и тем же проектом нескольким разработчикам, при этом имея всегда последнее рабочее состояние проекта.
